<!-- Required Jquery -->
<script type="text/javascript" src="{{ url('/') }}/public/assets/js/jquery/jquery.min.js"></script>
<script type="text/javascript" src="{{ url('/') }}/public/assets/js/jquery-ui/jquery-ui.min.js "></script>
...
<script type="text/javascript" src="{{ url('/') }}/public/assets/pages/widget/excanvas.js "></script>
<!-- waves js -->
<script src="{{ url('/') }}/public/assets/pages/waves/js/waves.min.js"></script>
<!-- jquery slimscroll js -->
<script type="text/javascript" src="{{ url('/') }}/public/assets/js/jquery-slimscroll/jquery.slimscroll.js ">
</script>
<!-- modernizr js -->
...
<script src="{{ url('/') }}/public/assets/pages/widget/amchart/gauge.js"></script>
<script src="{{ url('/') }}/public/assets/pages/widget/amchart/serial.js"></script>
<script src="{{ url('/') }}/public/assets/pages/widget/amchart/light.js"></script>
<script src="{{ url('/') }}/public/assets/pages/widget/amchart/pie.min.js"></script>
